...
- **Smart Categorization & AI:** Integrates with AI (Gemini) to process and analyze data (e.g., auto-categorization or analytics).
...
- Cloudinary (for scalable image/avatar uploads)
- Google Gemini API
...
1. Open a new terminal and navigate to the frontend directory:
   ...
   npm install
   ```
2. Create a `.env` (or `.env.local`) file in the `frontend/` directory with your Firebase Client configuration:
   ```env
